...
-- CAN THAN: file khoi tao sach, se XOA TOAN BO du lieu cu trong cnpm_db.
-- =========================================================
...
CREATE INDEX idx_product_images_product_sort ON product_images(product_id, is_thumbnail, sort_order);
CREATE INDEX idx_orders_customer_created ON orders(customer_id, order_created_at);
CREATE INDEX idx_orders_status_created ON orders(order_status_id, order_created_at);
CREATE INDEX idx_inventory_product_date ON inventory_transactions(product_id, transaction_at);
