      ...
      <div className="row mb-4">
        ...
        <div className="col-lg-5">
          <div className="d-flex flex-column h-100">
            ...
            <h4 className="text-muted mb-4">10.000.000 đ</h4>

            <div className="row g-3 mb-4">
              <div className="col">
                <button
                  className={"btn eshop-add-cart-btn py-2 w-100 " + (isAdded ? "is-added" : "")}
              ...
              <div className="col">
                <button
                  className={"btn eshop-buy-now-btn py-2 w-100 " + (isBuying ? "is-buying" : "")}
                  onClick={handleBuyNow}
                  type="button"
                >
                  <FontAwesomeIcon icon={["fas", isBuying ? "spinner" : "bolt"]} />
